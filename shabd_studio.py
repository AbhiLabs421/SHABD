...
function addMsg(role,text){
  ...
  const d=document.createElement('div'); d.className='msg '+role; d.textContent=text; m.appendChild(d);
...
function add(role,text){const m=document.getElementById('m');const d=document.createElement('div');
  d.className='m '+role;d.textContent=text;m.appendChild(d);m.scrollTop=m.scrollHeight;}
...
_EMBED_JS = r"""(function(){
  ...
  function add(role,text){var m=document.getElementById('shabd-m');var d=document.createElement('div');
    d.className='b '+(role==='user'?'u':'a');d.textContent=text;m.appendChild(d);m.scrollTop=m.scrollHeight;}
  add('a',"__GREETING__");
